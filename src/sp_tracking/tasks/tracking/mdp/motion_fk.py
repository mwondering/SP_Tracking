...
def angvel_from_quat_wxyz_torch(
...
class MotionFKHelper:
  ...
  def expand_motion(
    ...
    *,
    ...
    body_lin_vel_w = smooth_avg5_torch(finite_diff_torch(body_pos_w, fps, dim=0), dim=0)
    body_ang_vel_w = smooth_avg5_torch(
      angvel_from_quat_wxyz_torch(body_quat_w, fps, dim=0), dim=0
    )
