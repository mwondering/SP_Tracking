...
def test_tracking_entrypoint_registers_default_tasks() -> None:
  ...
  assert (
    registry.TRACKING_BFM_SPV5_1_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID
    in tasks
  )
  assert (
    registry.TRACKING_BFM_SPV5_1_MOE_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID
    in tasks
  )
  assert (
  ...
  assert (
    registry.TRACKING_BFM_SPV5_2_PMOE_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID
    in tasks
  )
  ...
  assert registry.TEST_POLICY_GRADIENTS_TASK_ID in tasks
...
def test_task_ids_describe_runtime_actor_and_critic_semantics() -> None:
  ...
  assert registry.TRACKING_BFM_SPV5_1_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID == (
  ...
  assert registry.TEST_POLICY_GRADIENTS_TASK_ID == (
