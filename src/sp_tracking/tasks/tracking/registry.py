...
from sp_tracking.tasks.tracking.task_catalog import TASK_BY_CONFIG_NAME, TASK_SPECS


TRACKING_BFM_TASK_ID = TASK_BY_CONFIG_NAME["tracking_bfm"].task_id
TRACKING_BFM_SP_TASK_ID = TASK_BY_CONFIG_NAME["tracking_bfm_sp"].task_id
TRACKING_BFM_SP_ABLATION_BFM_ACTOR_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_sp_ablation_bfm_actor"
].task_id
TRACKING_BFM_SP_ABLATION_STUDENT_ACTOR_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_sp_ablation_student_actor"
].task_id
TRACKING_BFM_SP_ABLATION_TEACHER_ACTOR_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_sp_ablation_teacher_actor"
].task_id
TRACKING_BFM_STUDENT_ACTOR_BFM_CRITIC_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_student_actor_bfm_critic"
].task_id
TRACKING_BFM_TEACHER_ACTOR_BFM_CRITIC_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_teacher_actor_bfm_critic"
].task_id
TRACKING_BFM_WBTELEOP_ACTOR_BFM_CRITIC_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_wbteleop_actor_bfm_critic"
].task_id
TRACKING_BFM_WBTELEOP_ACTOR_HEFT_CRITIC_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_wbteleop_actor_heft_critic"
].task_id
TRACKING_BFM_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_heft_reward"
].task_id
TRACKING_BFM_SP_ABLATION_BFM_ACTOR_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_sp_ablation_bfm_actor_heft_reward"
].task_id
TRACKING_BFM_SP_ABLATION_STUDENT_ACTOR_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_sp_ablation_student_actor_heft_reward"
].task_id
TRACKING_BFM_SP_ABLATION_TEACHER_ACTOR_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_sp_ablation_teacher_actor_heft_reward"
].task_id
TRACKING_BFM_STUDENT_ACTOR_BFM_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_student_actor_bfm_critic_heft_reward"
].task_id
TRACKING_BFM_TEACHER_ACTOR_BFM_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_teacher_actor_bfm_critic_heft_reward"
].task_id
TRACKING_BFM_WBTELEOP_ACTOR_BFM_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_wbteleop_actor_bfm_critic_heft_reward"
].task_id
TRACKING_BFM_WBTELEOP_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_wbteleop_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV1_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv1_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV2_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv2_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV3_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv3_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV4_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv4_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV5_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv5_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV5_1_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv5_1_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV5_1_MOE_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = (
  TASK_BY_CONFIG_NAME[
    "tracking_bfm_spv5_1_moe_actor_heft_critic_heft_reward"
  ].task_id
)
TRACKING_BFM_SPV5_1_ACTOR_HEFT_MOE_CRITIC_HEFT_REWARD_TASK_ID = (
  TASK_BY_CONFIG_NAME[
    "tracking_bfm_spv5_1_actor_heft_moe_critic_heft_reward"
  ].task_id
)
TRACKING_BFM_SPV5_2_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv5_2_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV5_2_PMOE_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = (
  TASK_BY_CONFIG_NAME[
    "tracking_bfm_spv5_2_pmoe_actor_heft_critic_heft_reward"
  ].task_id
)
TRACKING_BFM_SPV6_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv6_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV6_1_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv6_1_actor_heft_critic_heft_reward"
].task_id
TRACKING_BFM_SPV6_0_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID = TASK_BY_CONFIG_NAME[
  "tracking_bfm_spv6_0_actor_heft_critic_heft_reward"
].task_id
TEST_POLICY_GRADIENTS_TASK_ID = TASK_BY_CONFIG_NAME[
...
__all__ = [
  ...
  "TRACKING_BFM_SPV4_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV5_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV5_1_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV5_1_MOE_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV5_1_ACTOR_HEFT_MOE_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV5_2_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV5_2_PMOE_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV6_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV6_1_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TRACKING_BFM_SPV6_0_ACTOR_HEFT_CRITIC_HEFT_REWARD_TASK_ID",
  "TEST_POLICY_GRADIENTS_TASK_ID",
]
